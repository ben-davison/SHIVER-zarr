...
def safe_p2p_rechunk(mode):
    ...
    source_path = os.path.join(base_dir, "antarctica_multisource_velocity_spatial_200.zarr")
    
    if mode == "cubed":
        final_path = os.path.join(base_dir, "antarctica_multisource_velocity_cubed.zarr")
    elif mode == "timeseries":
        final_path = os.path.join(base_dir, "antarctica_multisource_velocity_timeseries.zarr")
    else:
